...
$CHAOS_PREFIX/bin/misc/testDataSetIO --loop 1000000 --points 100 --log-on-file 1 --log-level debug --log-file $CHAOS_PREFIX/log/testDataSetIO.log --direct-io-client-kv-param=ZMQ_RCVTIMEO:600000
