 ...
 */
#ifndef ChaosFramework___chaos_cu_name___h
#define ChaosFramework___chaos_cu_name___h
...
class __chaos_cu_name__ : public chaos::cu::RTAbstractControlUnit {
	std::string _device_id;
public:
    /*
     Construct a new CU with an identifier
     */
    __chaos_cu_name__(std::string& device_id);
    /*
