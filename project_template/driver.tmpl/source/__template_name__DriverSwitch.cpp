...
//! Execute a command
chaos::cu::driver_manager::driver::MsgManagmentResultType::MsgManagmentResult __template_name__Driver::execOpcode(chaos::cu::driver_manager::driver::DrvMsgPtr cmd) {
