...
./tools/chaos_remote_command.sh -u root -c "/etc/init.d/chaos-cu.sh stop" tools/config/lnf/production/beagle_list.txt 
chaos_remote_copy.sh -u root -s $BASE/bin/UnitServer ./tools/config/lnf/production/beagle_list.txt
chaos_remote_command.sh -u root -c "/etc/init.d/chaos-cu.sh start" ./tools/config/lnf/production/beagle_list.txt 
