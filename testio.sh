...
echo "set terminal png size 1024,768 enhanced font 'Verdana,10'" >> testioMulti.gnuplot  
echo "set output 'testDataSetIO.png'">> testioMulti.gnuplot  
...
for i in $nthreads;do
    ...
    echo "set title '$ threads'">> testioMulti.gnuplot  
